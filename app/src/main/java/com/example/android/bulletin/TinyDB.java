...
public class TinyDB {
   ...
   //  * @param defaultValue int value returned if key was not found
    ...
    public ArrayList<Article> getListObject(String key, Class<Article> mClass){
    	Gson gson = new Gson();
    	...
    	for(String jObjString : objStrings){
    		Article value  = gson.fromJson(jObjString,mClass);
    		objects.add(value);
    	}
    	return objects;
    }
   ...
   public <T> T getObject(String key, Class<T> classOfT){
    ...
    public void putListObject(String key, ArrayList<Article> objArray){
    	checkForNullKey(key);
    	Gson gson = new Gson();
    	ArrayList<String> objStrings = new ArrayList<String>();
    	for(Article obj : objArray){
